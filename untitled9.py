...
Original file is located at
    https://colab.research.google.com/drive/1HYvsr1eMEkbJPsJkevVdC0D3yn4-PJPv
"""
...
def main():
  ...
  if ask_btn and question.strip():
    ...
    # For demonstration, we’ll assume question and answer are captured in variables:
    question = st.session_state.get("last_question", "")
    answer = st.session_state.get("last_answer", "")

    # Show the answer without viz_spec block
    if answer:
      st.subheader("Answer")
      st.write(answer)

    # After showing the answer (in your Q&A logic section), add suggestion capture:
