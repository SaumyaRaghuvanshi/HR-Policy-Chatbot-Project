...
def main():
    ...
    # If a chip was clicked, treat it as the prompt
    ...
    if prompt := st.chat_input("Ask me about HR policies..."):
        ...
        is_hr_related = any(word in prompt.lower() for word in hr_keywords)
        ...
        qvec = embed_texts(embedder, [prompt])[0]
